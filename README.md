<table>
  <tr>
    ...
    <td width="250" valign="top" align="center">
      <img src="trycalling.jpg" alt="Try Profile" width="180" style="border-radius: 14px;" /><br/><br/>
      <h3>📞 Contact</h3>
      <p>
        <strong>📧</strong> trycalling1234@gmail.com<br/>
        <strong>🌍</strong> Phnom Penh, Cambodia<br/>
        <strong>💼</strong> <a href="https://www.linkedin.com/in/sroytry-neang-ab2048256/">LinkedIn</a>
      </p>

      <h3>🛠️ Tech</h3>
      <p align="left">
        <strong>Mobile:</strong><br/>
        Kotlin, Java, Flutter<br/><br/>
        <strong>Backend:</strong><br/>
        Spring Boot, Django, PHP<br/><br/>
        <strong>Cloud:</strong><br/>
        Firebase, AWS, MySQL, MongoDB<br/><br/>
        <strong>DevOps:</strong><br/>
        Docker, Jenkins, Git, Swagger
      </p>
    </td>
  ...
  **Android & Backend Developer**  
  ...
  `2021 – Present`  
  - Built Android banking apps using Kotlin and Android Jetpack  
  - Developed RESTful APIs with Spring Boot, MySQL, JWT  
  - Automated deployment with Jenkins + Docker  
  - Led internal system testing via Postman, Firebase

  ### 🧪 Freelance & GitHub Projects  
  - HRM system (Spring Boot + MongoDB)  
  - AI Chat App with GPT integration  
  - OCR scanner using CameraX + ML Kit  
  - MLBB Event Tracker + Player Dashboard
  ...
  📌 _Let’s build, solve, and innovate together._
