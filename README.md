<table>
  <tr>
    <!-- LEFT COLUMN -->
    <td width="360" valign="top" align="center" style="background-color:#f8f8f8; border-right:1px solid #ccc;">
      <br/>
      <img src="trycalling.jpg" alt="Try Profile" width="150" style="border-radius: 12px;" /><br/><br/>

      <h2>Sroytry Neang (Try)</h2>
      <strong>🎓 IT Engineering Student</strong><br/><br/>

      <h3>📞 Contact</h3>
      <p align="left">
        📱 011 739 900, 011 557 399<br/>
        ✉️ trycalling1234@gmail.com<br/>
        🎂 DoB: 30-Oct-2002<br/>
  ...
  - **Mobile Development:** Kotlin, Java, Android Jetpack, ML Kit  
  - **Backend API:** Spring Boot, JWT, MySQL, MongoDB  
  - **DevOps & Cloud:** Docker, GitHub Actions, Firebase  
  - **AI Tools:** ChatGPT API, OCR Scanner, Translation APIs

  ---

  ## 🧠 Summary

  Passionate and driven Android & backend developer with 3+ years of experience building scalable mobile and web applications. Specialized in Kotlin, Java, and Spring Boot. Graduate of Royal University of Phnom Penh and Google-certified Android Developer. Currently developing mobile banking apps and cloud-based APIs at Hattha Bank. Focused on clean architecture, DevOps, and innovation in AI-powered applications.
